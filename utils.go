...
// BuiltInTypes defines the correspondence between Go, TypeScript, C, Java,
...
func getBuildInTypeByLang(value, lang string) (buildType string, ok bool) {
	...
	if buildInTypes, ok = BuiltInTypes[value]; !ok {
		return
	}
...
func plural(isPlural bool) string {
	if isPlural {
		return "[]"
	}
